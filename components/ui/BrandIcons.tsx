/**
 * Brand-logo icons. Lucide 1.x removed Github/Linkedin (trademark cleanup),
 * so these are self-contained SVGs with a Lucide-compatible prop shape.
 */

interface IconProps {
  size?: number;
  className?: string;
  /** Accepted for call-site compatibility; brand glyphs are filled, not stroked. */
  strokeWidth?: number;
}
